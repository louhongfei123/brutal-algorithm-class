...
import { DataSourceComponent } from "./data-source.js";
...
async function main() {
    ...
    component.SortVisualizationComponent("insertion-sort", insertQueue, onLanguageChange);
    component.SortVisualizationComponent("merge-sort", mergeQueue, onLanguageChange);
    DataSourceComponent("data-source-1", array, resetChannel, onLanguageChange);
    // Kick off
